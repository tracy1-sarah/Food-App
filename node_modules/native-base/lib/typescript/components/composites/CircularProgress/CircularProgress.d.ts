...
declare const _default: React.MemoExoticComponent<React.ForwardRefExoticComponent<import("../../primitives/Box").InterfaceBoxProps<ICircularProgressProps> & {
    ...
    value: number;
    size?: import("../../types").ResponsiveValue<number | "0" | "1" | "2" | "3" | "px" | "full" | "sm" | "6" | "2xs" | "8" | "xs" | "12" | "md" | "4" | "16" | "xl" | "5" | "24" | "32" | "7" | "0.5" | "2.5" | "lg" | "2xl" | "1.5" | "10" | "20" | "64" | "80" | (string & {}) | "3.5" | "9" | "40" | "48" | "56" | "72" | "96" | "1/2" | "1/3" | "2/3" | "1/4" | "2/4" | "3/4" | "1/5" | "2/5" | "3/5" | "4/5" | "1/6" | "2/6" | "3/6" | "4/6" | "5/6" | "container" | "3xs">;
